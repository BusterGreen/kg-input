...
const OpenMenu = (data) => {
    ...
    let form = ["<form id='kg-input-form'>", `<div class="heading">${data.header != null ? data.header : "Form Title"}</div>`];
    ...
    $("#kg-input-form").on("change", function (event) {
    ...
    $("#kg-input-form").on("submit", async function (event) {
        if (event != null) {
